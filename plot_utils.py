...
def plot_inadimplencia_uf(df_agregado_uf: pd.DataFrame, title: str = "") -> go.Figure:
    ...
    fig = px.bar(df_agregado_uf, x='uf', y='taxa_inadimplencia_media', title=title,
                 labels={'uf': 'UF', 'taxa_inadimplencia_media': 'Taxa de Inadimplência Média (%)'},
                 color='taxa_inadimplencia_media', color_continuous_scale=px.colors.sequential.YlOrRd)
...
def plot_carteira_uf(df_agregado_uf: pd.DataFrame, title: str = "") -> go.Figure:
    ...
    fig = px.bar(df_agregado_uf, x='uf', y='volume_carteira_total', title=title,
                 ...
                 color='volume_carteira_total', color_continuous_scale=px.colors.sequential.Blues)
